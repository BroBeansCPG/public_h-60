class vxf_driver: vxf_driver {
    ...
    class interaction: interaction {
        class acreConfig {
            ...
            class btn_ics_r {
                positionType="Static";
                position="btn_comm_push1_r";
                label="Open ICS";
                radius=0.025;
                clickSound="vxf_Switch_Sound";
                buttonUp="[-1, false] call acre_sys_intercom_fnc_openGui";
            }; // btn_ics_r
        }; // acreConfig
    }; // interaction
}; // pilot
